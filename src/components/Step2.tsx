...
const Step2 = ({ step }: Props & { step: any }) => {
    return (
        <div className='embla__slide'>
            <div className='h-full p-4 sm:p-6 md:p-8 flex flex-col gap-4 rounded-lg border border-solid border-blue-700 text-center cursor-pointer group hover:border-blue-400 duration-200'>
                <a
                    href={step.href}
                    target="_blank"
                ...
                <div className="flex-1 flex justify-betweeen gap-4 items-end">
                    ...
                    >
                        {step.live && <a href={step.live} target='_blank'>View Live &rarr;</a>}
                    </div>
                </div>
            </div>
        </div>
