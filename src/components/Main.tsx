    ...
    <div className="mt-20">
      <main className="relative z-[20] flex flex-col flex-1 p-4">
        ...
        <section id="skills" className="py-8 sm:py-14 flex flex-col gap-2">
          <div className="flex flex-col gap-2 text-center relative before:absolute before:top-0 before:left-0 before:w-2/3 before:h-1.5 before:bg-blue-700 after:absolute after:bottom-0 after:right-0 after:w-2/3 after:h-1.5 after:bg-blue-700 py-4">
            <h6 className="text-large sm:text-xl md:text-2xl">
              View my tech stack.
            </h6>
            <h3 className="font-semibold text-3xl sm:text-4xl md:text-5xl">
